...
class Ui_splineOptions(object):
    ...
    def retranslateUi(self, splineOptions):
        ...
        self.label.setText(QCoreApplication.translate("splineOptions", u"Control points:", None))
#if QT_CONFIG(tooltip)
        self.showCheckBox.setToolTip(QCoreApplication.translate("splineOptions", u"Hide the blue control points", None))
#endif // QT_CONFIG(tooltip)
        self.showCheckBox.setText(QCoreApplication.translate("splineOptions", u"Show", None))
#if QT_CONFIG(tooltip)
        self.strengthCheckBox.setToolTip(QCoreApplication.translate("splineOptions", u"Optimize control point position when moving a knot", None))
#endif // QT_CONFIG(tooltip)
        self.strengthCheckBox.setText(QCoreApplication.translate("splineOptions", u"Optimize strength", None))
        self.slopeCheckBox.setText(QCoreApplication.translate("splineOptions", u"Optimize slope", None))
        self.neighbourCheckBox.setText(QCoreApplication.translate("splineOptions", u"Optimize neighbours", None))
    # retranslateUi
