...
class Ui_AnnotationView(object):
    def setupUi(self, AnnotationView):
        ...
        self.toolButton_12 = QtWidgets.QToolButton(self.widget_4)
    ...
    def retranslateUi(self, AnnotationView):
        ...
        self.downButton_2d.setText(_translate("AnnotationView", "..."))
        self.deleteButton_2d.setText(_translate("AnnotationView", "..."))
        self.registerButton_2d.setToolTip(_translate("AnnotationView", "Register selected images"))
        self.registerButton_2d.setText(_translate("AnnotationView", "..."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.layers2d), _translate("AnnotationView", "2D"))
        self.opacitySliderLabel_3d.setText(_translate("AnnotationView", "Opacity"))
        self.addButton_3d.setText(_translate("AnnotationView", "..."))
        self.upButton_3d.setText(_translate("AnnotationView", "..."))
        self.downButton_3d.setText(_translate("AnnotationView", "..."))
        self.deleteButton_3d.setText(_translate("AnnotationView", "..."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.layers3d), _translate("AnnotationView", "3D"))
        self.label_2.setText(_translate("AnnotationView", "Tools"))
        self.toolButton_8.setText(_translate("AnnotationView", "..."))
        self.toolButton_11.setText(_translate("AnnotationView", "..."))
        self.penButton.setText(_translate("AnnotationView", "..."))
        self.toolButton_10.setText(_translate("AnnotationView", "..."))
        self.toolButton_9.setText(_translate("AnnotationView", "..."))
