...
class Ui_LayerGroupEntry(object):
    ...
    def retranslateUi(self, LayerGroupEntry):
        LayerGroupEntry.setWindowTitle(QCoreApplication.translate("LayerGroupEntry", u"Form", None))
        self.hideButton.setText(QCoreApplication.translate("LayerGroupEntry", u"...", None))
        self.label.setText(QCoreApplication.translate("LayerGroupEntry", u"Layer Group Name", None))
    # retranslateUi
