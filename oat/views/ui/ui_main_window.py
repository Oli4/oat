...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icons/baseline-undo-24px.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionUndo.setIcon(icon)
        self.actionRedo = QAction(MainWindow)
        self.actionRedo.setObjectName(u"actionRedo")
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/baseline-redo-24px.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.navigationDock = QDockWidget(MainWindow)
        self.navigationDock.setObjectName(u"navigationDock")
        self.navigationDockContents = QWidget()
        self.navigationDockContents.setObjectName(u"navigationDockContents")
        self.navigationDock.setWidget(self.navigationDockContents)
        MainWindow.addDockWidget(Qt.LeftDockWidgetArea, self.navigationDock)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"EyeLab", None))
        self.actionSave_as.setText(QCoreApplication.translate("MainWindow", u"Save as", None))
        self.actionOpen_Project.setText(QCoreApplication.translate("MainWindow", u"Open Project", None))
        self.action_vol.setText(QCoreApplication.translate("MainWindow", u"HE raw Export (.vol )", None))
        self.actionToggle2D.setText(QCoreApplication.translate("MainWindow", u"2D Viewer", None))
        self.actionToggle3D.setText(QCoreApplication.translate("MainWindow", u"3D Viewer", None))
        self.actionToogleToolbox.setText(QCoreApplication.translate("MainWindow", u"Toolbox", None))
...
#endif // QT_CONFIG(shortcut)
        self.action_cfp.setText(QCoreApplication.translate("MainWindow", u"CFP (.bmp/.tif/.jpg)", None))
        self.actionExport.setText(QCoreApplication.translate("MainWindow", u"Export", None))
        self.actionImportVol.setText(QCoreApplication.translate("MainWindow", u"Heyex Raw (.vol)", None))
        self.actionImportCfp.setText(QCoreApplication.translate("MainWindow", u"CFP", None))
        self.actionSave.setText(QCoreApplication.translate("MainWindow", u"Save", None))
        self.actionImportHEXML.setText(QCoreApplication.translate("MainWindow", u"Heyex XML (.xml)", None))
        self.actionImportBSFolder.setText(QCoreApplication.translate("MainWindow", u"B-Scans from folder", None))
        self.actionLayerAnnotationGuide.setText(QCoreApplication.translate("MainWindow", u"Layer Annotation Guide", None))
        self.actionAreaAnnotationGuide.setText(QCoreApplication.translate("MainWindow", u"Area Annotation Guide", None))
        self.actionRegistrationGuide.setText(QCoreApplication.translate("MainWindow", u"Registration Guide", None))
        self.actionShortcutSheet.setText(QCoreApplication.translate("MainWindow", u"Shortcut Sheet", None))
        self.actionImportNir.setText(QCoreApplication.translate("MainWindow", u"NIR", None))
        self.actionIntroduction.setText(QCoreApplication.translate("MainWindow", u"Introduction", None))
        self.menuFile.setTitle(QCoreApplication.translate("MainWindow", u"File", None))
        self.menuUpload.setTitle(QCoreApplication.translate("MainWindow", u"Import", None))
