...
class Ui_SceneTab(object):
    def setupUi(self, SceneTab):
        ...
        sizePolicy2.setHeightForWidth(self.optionsWidget.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, SceneTab):
        ...
        self.opacitySliderLabel.setText(QCoreApplication.translate("SceneTab", u"Opacity", None))
#if QT_CONFIG(tooltip)
        self.opacitySlider.setToolTip(QCoreApplication.translate("SceneTab", u"Change the opacity for all annotations", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.addButton.setToolTip(QCoreApplication.translate("SceneTab", u"Add new Annotation Layers", None))
#endif // QT_CONFIG(tooltip)
        self.addButton.setText(QCoreApplication.translate("SceneTab", u"...", None))
#if QT_CONFIG(tooltip)
        self.upButton.setToolTip(QCoreApplication.translate("SceneTab", u"Move selected layer up", None))
#endif // QT_CONFIG(tooltip)
        self.upButton.setText(QCoreApplication.translate("SceneTab", u"...", None))
#if QT_CONFIG(tooltip)
        self.downButton.setToolTip(QCoreApplication.translate("SceneTab", u"Move selected layer down", None))
#endif // QT_CONFIG(tooltip)
        self.downButton.setText(QCoreApplication.translate("SceneTab", u"...", None))
#if QT_CONFIG(tooltip)
        self.deleteButton.setToolTip(QCoreApplication.translate("SceneTab", u"Delete selected layer", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.optionsLabel.setText(QCoreApplication.translate("SceneTab", u"Options:", None))
    # retranslateUi
