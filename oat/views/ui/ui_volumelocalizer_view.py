...
class Ui_VolumeLocalizerView(object):
    def setupUi(self, VolumeLocalizerView):
        ...
        sizePolicy1.setHeightForWidth(self.graphicsViewLocalizer.sizePolicy().hasHeightForWidth())
        ...
        self.horizontalSpacer_3 = QSpacerItem(2, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)
        ...
        sizePolicy2.setHeightForWidth(self.graphicsViewVolume.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, VolumeLocalizerView):
        VolumeLocalizerView.setWindowTitle(QCoreApplication.translate("VolumeLocalizerView", u"Form", None))
    # retranslateUi
