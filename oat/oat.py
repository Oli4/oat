...
class oat(QMainWindow):
    """Create the main window that stores all of the widgets necessary for the application."""

    def __init__(self, parent=None):
        """Initialize the components of the main window."""
        super(oat, self).__init__(parent)
        self.resize(1024, 768)
        self.setWindowTitle('oat')
        window_icon = pkg_resources.resource_filename('oat.images',
    ...
    def file_menu(self):
        ...
        self.open_action.setStatusTip('Open a file into oat.')
    ...
    def tool_bar_items(self):
        ...
        open_icon = pkg_resources.resource_filename('oat.images',
